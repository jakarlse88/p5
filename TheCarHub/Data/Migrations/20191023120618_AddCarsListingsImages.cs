...
{
    public partial class AddCarsListingsImages : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImageItemId = table.Column<Guid>(nullable: false),
                    ImageLocation = table.Column<string>(nullable: true),
                    ListingItemListingId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Images", x => x.ImageItemId);
                    table.ForeignKey(
                        name: "FK_Images_Listings_ListingItemListingId",
                        column: x => x.ListingItemListingId,
                        principalTable: "Listings",
                        principalColumn: "ListingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_ListingItemListingId",
                table: "Images",
                column: "ListingItemListingId");
        }
